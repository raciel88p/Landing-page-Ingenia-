...
export function FinalCTA() {
  const [form, setForm] = useState({ nombre: "", empresa: "", correo: "", telefono: "", detalles: "" });
  ...
  const buildWhatsAppUrl = () => {
    const lines = [
      "Hola, me interesa solicitar una cotización de uniformes.",
      `*Nombre:* ${form.nombre}`,
    ...
    return `https://wa.me/50689437109?text=${encodeURIComponent(lines)}`;
  };
